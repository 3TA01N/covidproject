...
log_path = os.path.join("/home/ubuntu/covidproject/backend/Logs/RepoPull", datetime.now().strftime("%m-%d-%Y_%H:%M:%S")+ ".txt")
...
logging.info("running repo_pull.py")
try:
    ...
    jhudataPD = (pd.read_csv("/home/ubuntu/covidproject/backend/jhuData.csv", usecols=['state','country','date','cases','deaths']))
